					...
					<div class="row heading-title" data-header-style="<?php echo $blog_header_type; ?>">
						<div class="col span_12 section-title blog-title">
							...
							<div id="single-below-header">
								<span class="meta-author vcard author"><span class="fn"><?php echo __('By', NECTAR_THEME_NAME); ?>
								...
								<?php wp_reset_postdata(); 
									...
									?>
								<!-- end testy -->
									<?php// if (get_field('second_author') === 'none' ) : ?><?php// echo get_field('author'); ?>
<?php// else : ?><?php// echo get_field('author'); ?><?php// echo ', & ' ?><?php// echo get_field('second_author'); ?><?php //endif;?>
									
								
									<?php 
										$i = 0;
										$len = count($author_ids);
										...
										foreach( $author_ids as $author_id) {
											...
											//if it's the last in a string on more than two
											if( $len >= 3 && $i == $len - 1 ) {
												$author_before = ', and ';
											}
											
											echo $author_before . get_the_title( $author_id );
											$i++;
			...
			if($blog_type == 'std-blog-fullwidth' || $hide_sidebar == '1'){
				...
				echo '<div id="post-area" class="col '.$std_minimal_class.' span_9">';
				 ...
				 if(have_posts()) : while(have_posts()) : the_post(); 
					...
					echo '<a style="display: block;clear: both;padding-top: 1rem;font-size: 16px;" href="' . get_home_url(). '">Back to Blog</a>';
