				...
				<?php if( !is_single() ) { ?>
					...
					<div class="article-content-wrap">
						<div class="post-header">
							...
							<?php if(!($masonry_type == 'classic_enhanced' && $using_masonry == true)) { ?> 
								<span class="meta-author"><span>test<?php echo __('By tesst', NECTAR_THEME_NAME); ?></span> <?php the_author_posts_link(); ?></span> <span class="meta-category">| <?php the_category(', '); ?></span> <span class="meta-comment-count">| <a href="<?php comments_link(); ?>">
