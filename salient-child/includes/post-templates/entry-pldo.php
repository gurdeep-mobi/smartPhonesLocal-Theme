...
<div class="col span_12">
	...
	<?php $author_ids = get_field( 'author' ); ?>
		...
		<div class="top-bar">
			...
			<h4><?php the_date(); ?><span class="meta-category"> | <?php the_category(', '); ?> </span> <span class="meta-comment-count"></span> | <a href="<?php comments_link(); ?>"></a></h4>
		
		</div>
					
		<div class="post-header">
			
			<h3 class="title">dcxz<a href="<?php the_permalink(); ?>">dcxz<?php the_title(); ?></a></h3>	
			...
			IMG
					...
					<?php 
						...
						if ( has_post_thumbnail() ) {
							...
							echo '<a class="home-featured" href="' . get_permalink() . '">' . get_the_post_thumbnail($post->ID, 'portfolio-thumb', array('title' => '')) . '</a>';
